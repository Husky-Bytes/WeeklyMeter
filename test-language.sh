...
javac --release 8 -encoding UTF-8 -d "$LANGUAGE_OUT" "${LANGUAGE_SOURCES[@]}" "$LANGUAGE_SRC/LanguagePolicy.java" "$LANGUAGE_SRC/AppLanguage.java" "$LANGUAGE_SRC/Texts.java" "$LANGUAGE_SRC/BootReceiver.java" "$LANGUAGE_SRC/WeeklyMeterApplication.java" tests/LanguagePolicyTests.java
