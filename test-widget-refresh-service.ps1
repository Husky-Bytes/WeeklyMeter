...
foreach($name in @('WidgetRefreshService','Scheduler','UsageJob','RefreshFeedback','RefreshFeedbackModel','Messages')){$manualSources+=Join-Path $SourceRoot ('app/src/main/java/dev/yerin/weeklymeter/'+$name+'.java')}
