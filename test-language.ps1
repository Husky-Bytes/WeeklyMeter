...
foreach($name in @('LanguagePolicy','AppLanguage','Texts','BootReceiver','WeeklyMeterApplication')){$languageSources+=Join-Path $SourceRoot "app/src/main/java/dev/yerin/weeklymeter/$name.java"}
