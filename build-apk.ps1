...
try {
    ...
    Run-Native "$toolsPath\aapt2.exe" @('link','-I',$androidJar,'--manifest',"$projectPath\app\src\main\AndroidManifest.xml",'--java',"$buildPath\gen",'--min-sdk-version','26','--target-sdk-version','35','--version-code','7','--version-name','0.5.0','-o',"$buildPath\base.apk","$buildPath\resources.zip")
